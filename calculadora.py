...
from modulos.gradientes import CalculadoraGradientes  # Nuevo módulo
...
class CalculadoraFinanciera:
    def __init__(self):
        self.modulos = {
            ...
            '10': CalculadoraTIR(),
            '11': CalculadoraPago(),
            '12': CalculadoraGradientes()  # Nuevo módulo
        }
    ...
    def mostrar_menu(self):
        ...
        print("12. Cálculo de Gradientes")  # Nueva opción
        print("13. Salir")
        print("="*50)
    ...
    def ejecutar(self):
        while True:
            ...
            if opcion == "13":
                ...
                print("Opción no válida. Por favor, seleccione 1-13.")
